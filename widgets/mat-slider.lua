...
function mat_slider:get_value(_)
...
function mat_slider:get_read_only(_)
  return self._private.read_only
end

function mat_slider:layout(_, width, height)
  local layout = {}
  table.insert(layout, base.place_widget_at(self._private.progress_bar, 0, dpi(17), width, height - dpi(34)))

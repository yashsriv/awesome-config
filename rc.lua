...
widget_battery = require("widgets.battery")
widget_brightness = require("widgets.brightness")
widget_memory = require("widgets.memory")
widget_volume = require("widgets.volume")
...
awful.screen.connect_for_each_screen(function(s)
    ...
    -- Create the wibox
    s.myupperwibox = awful.wibar({ position = "top", screen = s })
    s.mylowerwibox = awful.wibar({ position = "bottom", screen = s })

    -- Add widgets to the wibox
    s.myupperwibox:setup {
